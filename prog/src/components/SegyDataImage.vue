    ...
    <div id="SegyDataImage" v-loading="isLoading">
        <el-dialog :visible.sync="idialog" title="choose a inline slice ">
            <div>
                ...
                <el-slider v-model="inlineValue" :min="workzone.inlineFrom" :max="workzone.inlineTo"></el-slider>
            </div>
            <div>
        ...
        <el-dialog :visible.sync="xdialog" title="choose a crossline slice ">
            <div>
                ...
                <el-slider v-model="xlineValue" :min="workzone.xlineFrom" :max="workzone.xlineTo"></el-slider>
            </div>
            <div>
        ...
        <el-dialog :visible.sync="tdialog" title="choose a time slice ">
            <div>
                ...
                <el-slider v-model="timeValue" :min="workzone.timeFrom" :max="workzone.timeTo"></el-slider>
            </div>
            <div>
        ...
        <div>
            <el-menu  class="el-menu-demo" mode="horizontal"  >
                <el-submenu index="0">
                    <template slot="title">Draw Image Setting</template>
...
export default {
    ...
    methods:{
        ...
        getDrawData(change){
                ...
                let _this = this;
                if(change==='depth'){
                let value = this.$data.timeValue-this.$data.workzone.timeFrom;
                this.$axios({
                    method:'get',
                    ...
                    let value = this.$data.xlineValue-this.$data.workzone.xlineFrom
                    ...
                    let value = this.$data.inlineValue-this.$data.workzone.inlineFrom;
